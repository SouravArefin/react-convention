...
const About = () => {
    ...
    <div>
        ...
        <div data-aos="fade-up-left" style={{margin:"20%"}}className="custom-shadow">
                <div className='pt-2'>
                    
                <img style={{marginLeft: '45%'}}className="w-20 mt-5 h-20 rounded-full  "src={sourav} alt=''/>
        ...
        <p className='text-blue-500 font-bold p-10 text-center sp-style text-2xl'>Web Developer</p>  
           ...
           <div className='pt-2'>
           <img style={{marginLeft: '45%'}}className="w-20 mt-5 h-20 rounded-full  "src={promi} alt=''/>
       ...
       <div className='pt-2'>
       <img style={{marginLeft: '45%'}}className="w-20 h-20 rounded-full  "src={rahat} alt=''/>
     ...
     <div  className='pt-2'>
     <img style={{marginLeft: '45%'}}className="w-20 h-20 rounded-full  "src={sanjid} alt=''/>
        ...
        <p className='text-blue-500 font-bold p-10 text-center sp-style text-2xl'> Organizer</p>
            ...
            <div data-aos="flip-down" style={{ margin: "20%" }} className="custom-shadow">
                ...
                <div className='pt-2'>
                <img style={{marginLeft: '45%'}}className="w-20 h-20 rounded-full  "src={asraf} alt=''/>
